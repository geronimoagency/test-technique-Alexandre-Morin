(function($){
    $(function(){
        ...
        $('#comments').on('hidden.bs.modal', function(){
            $(this).find('.modal-header img.tn').removeAttr('src');
            $(this).find('.modal-header img.tn').removeAttr('srcset');
            $(this).find('.modal-header h3').text('');
            $(this).find('.modal-header p').text('');
            $(this).find('.modal-body h4>span').text('');
        });
    });
})(jQuery);